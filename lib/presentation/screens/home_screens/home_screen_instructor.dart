...
class _HomeScreenInstructorState extends State<HomeScreenInstructor> {
  ...
  void initState() {
    // TODO: implement initState
      ...
      if(cubit.instructorDataModel==null){
        cubit.GetInstructorData(Instructor_id!);

      }
      //cubit.GetInstructorCourses(Instructor_id!);
      if(cubit.inctructorcourses.isEmpty){
       cubit.GetInstructorCourses(Instructor_id!);
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<InstructorCubit,InstructorStates>(
     ...
     if(cubit.instructorDataModel==null || state is GetInstructorCoursesLoadingState){
